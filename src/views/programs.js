    ...
    <div className="programs-container">
      ...
      <div className="TopBar">
        ...
        <div className="Top TopNav">
          <Link to="/" className="programs-navlink button">
            Newsfeed
          </Link>
          <Link to="/marketplace" className="programs-navlink1 button">
            Marketplace
          </Link>
          <button type="button" className="button ActiveButton">
            Programs
          </button>
          <Link to="/jobs" className="programs-navlink2 button">
            Jobs
          </Link>
          <Link to="/challenges" className="programs-navlink3 button">
            Challenges
          </Link>
        </div>
      ...
      <div className="programs-container4 TopNav Bot">
        <Link to="/" className="programs-navlink4 button">
        ...
        <Link to="/marketplace" className="programs-navlink5 button">
        ...
        <button type="button" className="programs-button1 button ActiveButton">
        ...
        <Link to="/jobs" className="programs-navlink6 button">
        ...
        <Link to="/challenges" className="programs-navlink7 button">
