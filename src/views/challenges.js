    ...
    <div className="challenges-container">
      ...
      <div className="challenges-top-bar TopBar">
        ...
        <div className="Top TopNav">
          <Link to="/marketplace" className="challenges-navlink button">
            Newsfeed
          </Link>
          <Link to="/marketplace" className="challenges-navlink1 button">
            Marketplace
          </Link>
          <Link to="/programs" className="challenges-navlink2 button">
            Programs
          </Link>
      ...
      <div className="challenges-container4 TopNav Bot">
        <Link to="/" className="challenges-navlink4 button">
        ...
        <Link to="/marketplace" className="challenges-navlink5 button">
        ...
        <Link to="/jobs" className="challenges-navlink6 button">
        ...
        <Link
          to="/challenges"
          className="challenges-navlink7 button ActiveButton"
        >
