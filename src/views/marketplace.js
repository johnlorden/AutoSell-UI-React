    ...
    <div className="marketplace-container">
      ...
      <div className="TopBar">
        ...
        <div className="Top TopNav">
          <Link to="/" className="marketplace-navlink button">
            Newsfeed
          </Link>
          <button type="button" className="button ActiveButton">
            Marketplace
          </button>
          <Link to="/programs" className="marketplace-navlink1 button">
            Programs
          </Link>
          <Link to="/jobs" className="marketplace-navlink2 button">
            Jobs
          </Link>
          <Link to="/challenges" className="marketplace-navlink3 button">
            Challenges
          </Link>
        </div>
      ...
      <div className="TopNav Bot">
        <Link to="/" className="marketplace-navlink4 button">
        ...
        <Link
          to="/marketplace"
          className="marketplace-navlink5 button ActiveButton"
        >
        ...
        <Link to="/challenges" className="marketplace-navlink7 button">
